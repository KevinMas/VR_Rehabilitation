...
namespace Leap.Unity {
  ...
  public class CapsuleHand : IHandModel {
    ...
    public override void UpdateHand() {
	  ...
	  //This the original way to draw this sphere
	  ...
	  //For a ergonomy problem, I made it by myself, it is very dirty, I didn'y found an other way
	  Vector3 mockThumbJointPos;
	  if(_hand.IsLeft)
		mockThumbJointPos= _hand.PalmPosition.ToVector3 () + new Vector3( -0.03f , -0.03f , -0.03f );
	  else
		mockThumbJointPos = _hand.PalmPosition.ToVector3 () + new Vector3( 0.03f , -0.03f , -0.03f );
